// src/components/auth/ShooterLoginForm.tsx
...
export function ShooterLoginForm({
  isDarkMode,
  isAr,
  t,
  onBack,
    ...
    >
      <div className="flex items-center gap-2 mb-4 select-none">
        ...
        <h3 className="font-sans admin-text-lg font-bold text-gray-800 dark:text-white uppercase truncate">
          {isAr ? "بوابة دخول المسدس" : "Shooter Login"}
        </h3>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={isAr ? "اسم المستخدم" : "Shooter ID"}
            />
          </div>
        </div>
        ...
        >
          {isAr ? "بدء تسجيل الدخول" : "Start Shooting Session"}
        </button>
      </form>
    </motion.div>
  );
